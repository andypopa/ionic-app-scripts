...
const inject_scripts_1 = require("./inject-scripts");
    ...
    describe('injectCoreHtml', () => {
        it('should replace an existed injected script tag', () => {
            const inputHtml = '' +
                ...
                '</body>\n' +
                '</html>';
            const output = inject_scripts_1.injectCoreHtml(inputHtml, '  <script data-ionic="inject">\n' +
                '    alert(55555);\n' +
                '  </script>');
        ...
        it('should add script to top of file when no html tag', () => {
            const inputHtml = '' +
                '<body>\n' +
                '</body>';
            const output = inject_scripts_1.injectCoreHtml(inputHtml, '<injected></injected>');
