import { ClassDeclaration, Decorator, Node, NodeArray, ObjectLiteralElement, // tslint:disable-line: no-unused-variable
ObjectLiteralExpression, ScriptTarget, SourceFile, SyntaxKind } from 'typescript';
