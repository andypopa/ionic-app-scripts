...
describe('highlight.js', () => {
    describe('highlightError', () => {
        it('should error highlight unescaped', () => {
            ...
            const errorLength = 1;
            const v = highlight_1.highlightError(htmlInput, errorCharStart, errorLength);
            expect(v).toEqual(`x <span class="ion-diagnostics-error-chr">&</span> y`);
        });
        it('should error highlight escaped >', () => {
            const sourceText = `x > y`;
            const htmlInput = highlight_1.highlight('typescript', sourceText, true).value;
            const errorCharStart = 2;
            const errorLength = 1;
            const v = highlight_1.highlightError(htmlInput, errorCharStart, errorLength);
            expect(v).toEqual(`x <span class="ion-diagnostics-error-chr">&gt;</span> y`);
    ...
    describe('typescript', () => {
        it('should replace typescript with <', () => {
            const sourceText = `if (x < y) return;`;
            const v = highlight_1.highlight('typescript', sourceText, true).value;
    ...
    describe('html', () => {
        it('should replace html', () => {
            ...
            const v = highlight_1.highlight('html', sourceText, true).value;
    ...
    describe('scss', () => {
        it('should replace scss', () => {
            ...
            const v = highlight_1.highlight('scss', sourceText, true).value;
